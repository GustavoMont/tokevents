...
export default function Index(){
    const login = [
        ...
        {label: 'Senha', name: 'password', type: 'password', key: 'login_password'},
    ]
    const cadastro = [
    ...
    return (
        <>
            <section>
                <Form inputs={login} method={"POST"} action="/auth/login" butao="Login" submit={handleLogin} />
                <hr />
                <Form inputs={cadastro} method={"POST"} action="/auth/signIn" butao="Cadastrar" submit={handleSignIn} />
